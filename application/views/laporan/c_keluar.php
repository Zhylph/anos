...
<html><head>
    ...
    <h6 class="status">Laporan Riwayat Barang Keluar</i></h6>
    <table width="100%" border="1" class="center">
        ...
        foreach ($permintaan as $d) : ?>
            ...
            <tr>
                ...
                <td align="center"><?= date('d F Y', strtotime($d['tanggal_permintaan'])); ?></td>
                <td align="center"><?= date('d F Y', strtotime($d['tanggal_dibutuhkan'])); ?></td>
                <td align="center"><?= $d['jumlah_permintaan']; ?></td>
                <td align="center"><?= $d['jumlah_disetujui']; ?></td>
                <td align="center"><?= $d['satuan']; ?></td>
                <td align="center"><?= date('d F Y', strtotime($d['tanggal_persetujuan'])); ?></td>
                <td align="center"><?= date('d F Y', strtotime($d['tanggal_penyerahan'])); ?></td>
            </tr>
