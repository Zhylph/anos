            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('admin/editJBarang'); ?>" method="post" enctype="multipart/form-data">
                                <!--form_open_multipart untuk upload foto bawaan CI, harus diarahkan ke controler-->
                                <input type="hidden" name="id_jenis_barang" value="<?php echo $JBarang->id_jenis_barang ?>" readonly />

                                <div class="form-group row">
                                    <label for="jenis_barang" class="col-sm-2 col-form-label">Jenis Barang</label>
                                    <div class="col-sm-4">
                                        <input class="form-control <?php echo form_error('jenis_barang') ? 'is-invalid' : '' ?>" type="text" name="jenis_barang" value="<?php echo $JBarang->jenis_barang ?>"/>
