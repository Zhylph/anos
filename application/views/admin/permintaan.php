                        ...
                        <?php $i = 1; ?>
                            ...
                            <?php foreach ($permintaan as $pm) : ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php if($pm['bukti'] == NULL ) { ?>
                                        <a href="#" target="_blank" class="btn btn"><i class=""></i> </a>
                                    <?php } else { ?>
                                        <a href="<?= base_url('upload/berkas/' . $pm['bukti']); ?>" target="_blank" class="btn btn-small"><i class="fas fa-file"></i> </a>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($pm['status_penyerahan'] == 'diserahkan') { ?>
                                            ...
                                            <a href="<?php echo site_url('admin/pdfberita/' . $pm['id_permintaan']) ?>" class="btn btn-primary"><i class="fas fa-print"></i> </a>
                    ...
                    <form class="form-horizontal" action="<?= base_url('admin/serahkanPermintaan') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="col-lg-112">
                                    <input type="hidden" id="id_permintaan" name="id_permintaan" value="<?php echo $pm['id_permintaan']; ?>">
                                    Bukti penyerahan : <input type="file" class="form-control" id="bukti" name="bukti" value="<?php echo $pm['bukti']; ?>"><br>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
